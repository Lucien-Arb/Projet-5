...
function deleteProduct(id) {  
    document.getElementById("deleteButton-" + id).addEventListener("click", function ()  {       
       let productsIds = localStorage.getItem("itemsInCart");   
       productsIds = JSON.parse(productsIds); 

       if (productsIds !== null) {
           productsIds.remove();
           localStorage.setItem("itemsInCart", productsIds);  
           location.reload(); 
       }   
   });
}
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 text-sm-center col-md-4 text-md-right row">
                        ...
                        <div class = "col-4 col-sm-2 col-md-2 text-right">
                            <button id="deleteButton-${item[0].id}" type="button" class="btn btn-outline-danger btn-xs">
